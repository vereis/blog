...
description: |
  Oban isn't just for background jobs—you can use it for cron scheduling, API integrations, rate limiting, simple caches, and more.

  This post covers both conventional and unconventional (cursed?) ways to leverage Oban's powerful job processing system.

  Oban is powerful enough to be dangerous, so let's explore what's possible.
tags:
  - elixir
  - oban
---
