...
help:
	...
	@echo ""
	@echo "Utilities:"
	@echo "  make sync-litefs         Sync ecto_litefs from sibling directory"
...
# Sync ecto_litefs from sibling directory for Docker builds
sync-litefs:
	@echo "Syncing ecto_litefs from ../ecto_litefs..."
	rm -rf ecto_litefs
	cp -r ../ecto_litefs ./ecto_litefs
	rm -rf ecto_litefs/.git ecto_litefs/_build ecto_litefs/deps
	@echo "Done. ecto_litefs synced ($(du -sh ecto_litefs | cut -f1))"
